...
function draw() {
 ...
 // obstacle.debug=true;
  ...
  if (gameState===PLAY){
    ...
    textSize(90)
    text("Get 1000 points to win",displayWidth/4.8730964467,displayHeight/3.72413793103)
    ...
    textFont("neuehaasunica")
    fill("blue")
    text("You Have Won the Game",displayWidth/4.26666666667,displayHeight/3.75)
    fill("red")
    text("It was a long journey to be here",displayWidth/5.48571428571,displayHeight/2.51162790698)
    fill("yellow")
    text("congratulation!!!!!!!!!!!",displayWidth/3.09677419355,displayHeight/1.89473684211)
    fill("green")
    text("By the way sorry for bad colors:)",displayWidth/5.48571428571,displayHeight/1.58823529412)
    fill("black")
    score:"Victory"
